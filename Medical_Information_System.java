package Medical_Information_System;

import java.io.*;
import java.util.*;

public class Medical_Information_System {
	...
	public static void main(String[] args) throws Exception {
		...
		String medicine2prescribtion = medicine_2.prescribe(patient_2, doctorObjects[1]);
		
		System.out.println(medicine_1.prescribe(patient_3, doctorObjects[3]));
		medicine_2.printReceipt(medicine_2,medicine_2.getMedicineCost(),doctorObjects[1],patient_3);
...
class Hospital {
	...
	public boolean equal(Patient[] patients) {
		...
		return patients[index1].getID() == patients[index2].getID();
	...
	public boolean equal(Doctor[] dr) {
		...
		return dr[index1].getID() == dr[index2].getID();
	}
...
class Doctor extends Staff {
	...
	@Override
	public String toString() {
		return "The doctor name: " + getName() + ", id: " + getID() + " and specialty: " + specialty + ".";
...
class Nurse extends Staff {
	...
	public String toString() {
		return "The nurse's name is: " + getName() + "Shift Schedule: " + shift_Schedule;
	}
...
class Medicine extends Doctor {
	...
	public String prescribe(Patient patient, Doctor dr) {
		return "This is a prescription of " + this.getMedicineName() + " for: " + patient.getName() + " prescribed by "
				+ dr.getName() + ".";

	}

	public boolean equal(Medicine medicine1, Medicine medicine2) {
		return(medicine1.getMedicineName().equals(medicine2.getMedicineName()))
				&((medicine1.getMedicineCost()==medicine2.getMedicineCost())); 
	}

	public void printReceipt(Medicine medicine, int cost, Doctor dr, Patient patient) {
	
		System.out.printf("\n\nMedicine Name: %-10s\nPrescription: %-10s\nCost: %d SAR\n\n",
				medicine.getMedicineName(), medicine.prescribe(patient, dr ),
				this.medicine_cost);
